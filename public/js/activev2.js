...
active.prototype.bangtaji = function () {
    $('#btnBtj').bind('click', function () {
...
active.prototype.WeixinVersion = function () {
    if (navigator.userAgent.indexOf('MicroMessenger/6.1') != -1 && navigator.userAgent.indexOf('iPhone') != -1 && this.parent != this.visitor) {
